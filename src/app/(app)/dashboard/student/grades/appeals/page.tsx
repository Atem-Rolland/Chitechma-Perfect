      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            Please provide clear and concise reasons for your appeal, along with any supporting evidence.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">You can attach documents like graded papers, screenshots, communication with the lecturer, etc. (Max 5MB per file. Multiple files can be zipped.)</p>
          </div>
          ...
          <p className="text-sm text-muted-foreground text-center">
            ...
            Appeals should follow the official university procedure outlined in the student handbook.
          </p>
        </CardContent>
      </Card>
    </motion.div>
